                       ...
                       <div class="row">
                           ...
                           <div class="col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                <label class="text-dark" for="exampleInputDetails">{{ __('adminstaticword.Status') }} :</label>
                                <br>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input readonly value="{{ $key ? $key->secret_key : "" }}" type="text" name="apikey" class="form-control keyupdate" placeholder="API KEY For Blizzard Theme" aria-label="Username" aria-describedby="basic-addon1">
                                    ...
                                    <span class="alert alert-danger">
                                        ...
                                        <b>Important:</b>
                                        <a href="{{ url('/getsecretkey') }}" class="text-danger" target="_blank">
