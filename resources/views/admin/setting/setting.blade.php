      ...
      @endif
        ...
        <div class="card m-b-30">
                ...
                <ul class="nav nav-tabs mb-3" id="defaultTab" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#whatsapp" role="tab" aria-controls="profile" aria-selected="false">&nbsp;&nbsp;{{ __('Whatsapp Chat') }}</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="profile-tab" data-toggle="tab" href="#faceboo" role="tab" aria-controls="profile" aria-selected="false">&nbsp;&nbsp;{{ __('Facebook Chat') }}</a>
                  </li>
                    </ul>
