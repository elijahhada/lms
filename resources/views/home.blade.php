                ...
                <div class="facts-block text-center">
                    <div class="facts-block-one">
                        ...
                        <img src="{{ Avatar::create($factset->title)->toBase64() }}" alt="course"
                            class="img-fluid">
                        @endif
                        <!-- <div class="fact-hover-img">
                            <a href="#" title=""><img src="{{ url('/images/facts/'.$factset->image) }}" class="img-fluid" alt="" />
                            </a>
                        </div> -->
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                        ...
                                        <div class="rate text-right">
                                            <ul>
                                                ...
                                                <li><a><b>{{ activeCurrency()->symbol }}{{ price_format( currency($discount['discount_price'], $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false)) }}</b></a>
                                                </li>

                                                <li><a><b><strike>{{ activeCurrency()->symbol }}{{ price_format( currency($discount['price'], $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false) ) }}</strike></b></a>
                                                </li>
                                                ...
                                                @if($c->price == !NULL)
                                                <li><a><b>{{ activeCurrency()->symbol }}{{ price_format( currency($discount['price'], $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false) ) }}</b></a>
                                                </li>
                                                @endif
...
<!-- Bundle start -->
@if(isset($bundles) && $hsetting->bundle_enable)
                ...
                <div class="genre-slide-image @if($gsetting['course_hover'] == 1) protip @endif"
                    ...
                    <div class="view-block">
                        ...
                        <div class="view-user-img">
                            ...
                            @if(optional($best->user)['user_img'] !== NULL && optional($best->user)['user_img'] !== '')
                            <a href="" title=""><img src="{{ asset('images/user_img/'.$best->user['user_img']) }}"
                                    class="img-fluid user-img-one" alt=""></a>
                            @else
                            <a href="" title=""><img src="{{ asset('images/default/user.png') }}"
                                    class="img-fluid user-img-one" alt=""></a>
                        ...
                        <div class="view-dtl">
                            ...
                            <div class="user-name">
                                <h6>By <span>{{ optional($best->user)['fname'] }}</span></h6>
                            </div>
                            <div class="rating">
                                <ul>
                                    <li>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                        ...
                                        <div class="rate text-right">
                                            <ul>
                                                ...
                                                <li><a><b>{{ activeCurrency()->symbol }}{{ price_format( currency($best->courses['discount_price'], $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false)) }}</b></a>
                                                </li>

                                                <li><a><b><strike>{{ activeCurrency()->symbol }}{{ price_format( currency($best->courses['price'], $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false) ) }}</strike></b></a>
                                                </li>
                                                ...
                                                @if($c->price == !NULL)
                                                <li><a><b>{{ activeCurrency()->symbol }}{{ price_format( currency($c->courses['price'], $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false) ) }}</b></a>
                                                </li>
                                                @endif
                    ...
                    <a href="{{ route('category.page',['id' => $t->id, 'category' => str_slug(str_replace('-','&',$t->slug))]) }}">
                        <div class="image-overlay">
                            <span><i class="fa {{ $t['icon'] }}"></i>{{ $t['title'] }}
                                <div class="categories-img-count">{{ $t->courses->count() }} Courses</div>
                            </span>
                         </div>
                        @if($t['cat_image'] == !NULL)
...
<section id="testimonial" class="testimonial-main-block">
    <div class="container">
        <h4>{{ __('frontstaticword.HomeTestimonial') }}</h4>
                ...
                <div class="instructor-home-block text-center">
                    <div class="instructor-home-block-one">
                        ...
                        <div class="instructor-home-btn">
                            <a href="{{ route('allinstructor/profile') }}" class="btn btn-primary" title="Profile">Profile</a>
                        </div>
