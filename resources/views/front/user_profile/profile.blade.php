            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="bredcrumb-dtl">
                        <h1 class="wishlist-home-heading">{{ __('frontstaticword.UserProfile') }}</h1>
                    </div>
                </div>
            </div>
        </div>
	                    ...
	                    <div class="row">
	                        <div class="col-lg-6">
	                            <div class="form-group">
	                                ...
	                                <input type="text" id="name" name="fname" class="form-control" placeholder="{{ __('frontstaticword.EnterFirstName') }}" value="{{ $orders->fname }}" required>
	                            </div>
	                            <div class="form-group">
	                        ...
	                        <div class="col-lg-6">
	                            <div class="form-group">
	                                ...
	                                <input type="text" id="lname" name="lname" class="form-control" placeholder="{{ __('frontstaticword.EnterLastName') }}" value="{{ $orders->lname }}" required>
	                            </div>
	                            <div class="form-group">
