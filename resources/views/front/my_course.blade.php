            ...
            <div class="col-lg-3 col-sm-6">
                ...
                <div class="view-block">
                    ...
                    <div class="view-dtl">
                        ...
                        <p class="btm-10"><a herf="#">{{ __('frontstaticword.by') }} @if(isset($bbl->user))
            ...
            <div class="col-lg-3 col-sm-6">
                ...
                <div class="view-block">
                    ...
                    <div class="view-dtl">
                        ...
                        <p class="btm-10"><a herf="#">{{ __('frontstaticword.by') }} @if(isset($meeting->user))
            ...
            <div class="col-lg-3 col-sm-6">
                ...
                <div class="view-block">
                    ...
                    <div class="view-dtl">
                        ...
                        <div class="user-name">
                            <h6>By <span>{{ optional($enrol->courses->user)['fname'] }}</span></h6>
                        </div>
    ...
    <div class="container-fluid">
        <div class="business-dtl">
            <div class="row">
                <div class="col-lg-6">
                    <div class="bredcrumb-dtl">
                        <h1 class="wishlist-home-heading">{{ __('frontstaticword.MySubscribedCourses') }}</h1>
                    </div>
                </div>
            </div>
        </div>
...
<section id="no-result-block" class="no-result-block">
    <div class="container">
        <div class="no-result-courses">{{ __('frontstaticword.whenenroll') }}&nbsp;<a
                href="{{ url('/') }}"><b>{{ __('frontstaticword.Browse') }}</b></a></div>
    </div>
</section>
@endif
