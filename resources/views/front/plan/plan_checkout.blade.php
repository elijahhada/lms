            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="bredcrumb-dtl">
                        <h1 class="wishlist-home-heading">{{ __('frontstaticword.Plan') }} {{ __('frontstaticword.Checkout') }}</h1>
                    </div>
                </div>
            </div>
        </div>
	            	...
	            	<div class="checkout-pricelist">
		            	<ul>
		            		@if($plans->discount_price == !NULL)
                               ...
                               <li><h1 class="checkout-total">{{ __('frontstaticword.Total') }}: <i class="{{ $currency->icon }}"></i>{{ $plans->price }}</h1></li>
		            			<li><div class="checkout-price"><s><i class="{{ $currency->icon }}"></i>{{ $plans->discount_price }}</s></div></li>

                                
                            @else
                               <li><h1 class="checkout-total">{{ __('frontstaticword.Total') }}: {{ $plans->price }}<i class="{{ $currency->icon }}"></i></h1></li>
