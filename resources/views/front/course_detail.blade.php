            ...
            <div class="col-lg-8 col-md-8">
                <div class="about-home-block">
                    ...
                    <ul>
                        ...
                        <li><a href="#" title="about">{{ __('frontstaticword.Created') }}: @if(isset($course->user)) <a href="{{ route('instructor.profile', ['id' => $course->user->id, 'name' => $fullname] ) }}" title="instructor"> {{ $course->user['fname'] }} {{ $course->user['lname'] }} </a> @endif</a></li>
                                ...
                                <div class="about-home-rate">
                                    <ul>
                                        ...
                                        @if($course->discount_price == !NULL)
                                            ...
                                            <li>{{ activeCurrency()->symbol }}{{ price_format(  currency($course->discount_price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false)) }}</li>
                                            <li><span><s>{{ activeCurrency()->symbol }}{{ price_format(  currency($course->price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false)) }}</s></span></li>
                                    ...
                                    @if($item->discount_price == !NULL)
                                        <div class="course-currency txt-rgt">
                                            <ul>
                                                ...
                                                <li class="rate">{{ activeCurrency()->symbol }}{{ price_format(  currency($item->discount_price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false)) }}</li>

                                                <li class="rate"><s>{{ activeCurrency()->symbol }}{{ price_format(  currency($item->price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false)) }}</s></li>
                                    ...
                                    <div class="view-block">
                                        ...
                                        <div class="view-user-img">
                                            @if($rel->user['user_img'] !== NULL && $rel->user['user_img'] !== '')
                                                <a href="" title=""><img src="{{ asset('images/user_img/'.$rel->user['user_img']) }}" class="img-fluid user-img-one" alt=""></a>
                                            @else
                                        ...
                                        <div class="img-wishlist">
                                            <div class="protip-wishlist">
                                                <ul>
                                                    @if(Auth::check())
                                                        @php
                                                            $wish = App\Wishlist::where('user_id', Auth::User()->id)->where('course_id', $rel->course_id)->first();
                                                        @endphp
                                                        @if ($wish == NULL)
                                        ...
                                        <div class="view-dtl">
                                            ...
                                            <div class="user-name">
                                                <h6>By <span>{{ optional($rel->courses->user)['fname'] }}</span></h6>
                                            </div>                                            
                                            <div class="rating">
                                                <ul>
                                                    <li>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                                        @if( $rel->courses->type == 1)
                                                            ...
                                                            @if($rel->courses->discount_price == !NULL)
                                                                <div class="rate text-right">
                                                                    <ul>
                                                                        ...
                                                                        <li><a><b>{{activeCurrency()->symbol }}{{ price_format(  currency($rel->courses->discount_price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false)) }}</b></a></li>

                                                                        <li><a><b><strike>{{ activeCurrency()->symbol }}{{ price_format(  currency($rel->courses->price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false)) }}</strike></b></a></li>
                                                            ...
                                                            @else
                                                                <div class="rate text-right">
                                                                    <ul>
                                                                       <li><a><b>{{activeCurrency()->symbol }}{{ price_format(currency($rel->courses->price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false)) }}</b></a></li>
