                ...
                <div class="col-lg-3 col-md-6">
                    <div class="view-block">
                        ...
                        <div class="view-dtl">
                            ...
                            <div class="user-name">
                                <h6>By <span>{{ optional($wish->courses->user)['fname'] }}</span></h6>
                            </div>
                            <div class="rating">
                                <ul>
                                    <li>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                                        ...
                                        <div class="rate text-right">
                                            <ul>
                                                ...
                                                <li><a><b>{{ activeCurrency()->symbol }}{{ price_format( currency($wish->courses->discount_price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false))}}</b></a>
                                                </li>

                                                <li><a><b><strike>{{ activeCurrency()->symbol }}{{ price_format( currency($wish->courses->price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false)) }}</strike></b></a>
                                                </li>


                                                @else
                                                <li><a><b>
                                                            {{ activeCurrency()->symbol }}{{ price_format( currency($wish->courses->price, $from = $currency->code, $to = Session::has('changed_currency') ? Session::get('changed_currency') : $currency->code, $format = false) )}}</b></a>
                                                </li>
                                ...
                                <li class="protip-wish-btn">   
                                    ...
                                    <div class="cart-btn">
                                        <form id="demo-form2" method="post" action="{{ route('addtocart',['course_id' => $wish->courses->id, 'price' => $wish->courses->price, 'discount_price' => $wish->courses->discount_price ]) }}"
                                            ...
                                            <button type="submit" class="btn btn-primary heart-fill"  title="Add To Cart"><i
